  ...
  return (
    <div className="header">
      <div className="headerList">
        ...
        <h1 className="headerTitle">A lifetime of Discounts? Sounds Good</h1>
        <p className="headerDesc">
          Get Rewarded for Your Travels. Unlock instant savings of 10% or more
          with a free  PreBook account
        </p>
        ...
        <div className="headerSearchItem">
          ...
          <input type="text" placeholder="Your Destination" className="headerSearchInput" />
        </div>
